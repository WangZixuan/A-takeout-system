...
<li <?php comment_class('hpr'); ?> id="comment-<?php comment_ID() ?>">
<div id="div-comment-<?php comment_ID() ?>" class="comment-content">
<?php if ( get_comment_type() == "comment" ) : ?>
<div class="comment-author vcard">
<div class="<?php if($comment->user_id == 0) {echo 'visitor ';} else {echo 'admin ';} ?>gravatar hpa hfl"><?php echo get_avatar( $comment, 36, $avatar); ?></div>
<small class="comment-meta hfr"><a href="#comment-<?php comment_ID() ?>"><?php comment_date('Y 年 m 月 d 日') ?> <?php comment_time() ?></a> <?php edit_comment_link('编辑','- ',''); ?></small>
<span class="comment-author-name"><?php comment_author_link() ?></span><cite class="comment-id hdn"><?php comment_ID() ?></cite>
</div>
...
<?php else : ?>
<?php if ($comment->comment_approved == '0') : ?><div class="comment-meta">您的评论正在审核。</div><?php endif; ?>
<div class="comment-meta"><small class="hfr"><a href="#comment-<?php comment_ID() ?>"><?php comment_date('Y 年 m 月 d 日') ?> <?php comment_time() ?></a> <?php edit_comment_link('编辑','- ',''); ?></small><span class="hfl">Trackback</span><br/><?php comment_author_link(); ?></div>
<?php endif ?>
</div>
<?php } ?>
<div id="comments">
...
<?php else : ?>
<div class="fuss nova">评论当前被关闭。</div>
<?php endif; ?>
<?php endif; ?>
<?php if ( comments_open() ) : ?>
<div id="respond">
...
<?php else : ?>
<div class="visitor gravatar hfr"><a href="http://www.gravatar.com/" rel="external nofollow" target="_blank" title="设置您的 Gravatar 头像"><?php echo get_avatar( esc_attr($comment_author_email), 36, $avatar); ?></a></div>
...
<p><input name="submit" type="submit" id="submit" class="form-btn hfl" tabindex="5" value="发表评论" />
<span id="cancel-comment-reply" class="form-cancel hfl"><?php cancel_comment_reply_link('取消回复') ?></span>
<div class="hcf"></div>
